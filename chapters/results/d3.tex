...
% If e.g. all orders from the SuperSale-Store dataset should be shown for each state, \ac{D3} features a functionality to calculate the centroids of items, allowing/
\end{enumerate}
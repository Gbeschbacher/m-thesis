...
\begin{table}[!htp]
    \begin{tabular}{M{26mm}|| M{26mm} | M{26mm} | M{26mm} | M{26mm} N}
...
%
% MAYBE DESCRIBE "CODE-FLOW"; changing visual representation triggers a window on-change function; this either checks if transition
%



% These are used in the transition manager to create the different animated transitions to each other type of visualisation.
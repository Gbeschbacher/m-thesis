...
\subsubsection{Animated Transitions}
...
\begin{figure*}
    ...
    \begin{subfigure}[b]{0.475\textwidth}
        ...
        {{\small Multivariate classed proportional symbol map}}
...
Furthermore, figure \ref{f:showcase-transition-dot-cartogram} on page \pageref{f:showcase-transition-dot-cartogram} shows the animated transition from a dot map to the Pseudo-Demers cartogram. The figure needs to be read line by line.
...
\begin{figure*}
    ...
    \caption[Showcasing the implemented animated transition from a dot map to the Pseudo-Demers cartogram]
    {\small Showcasing the implemented animated transition from a dot map to the Pseudo-Demers cartogram.}

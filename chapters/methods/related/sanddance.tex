\citeauthor{Drucker2015} describes a tool which makes use of so-called unit visualisation. This type of visualisation is best described as using one complete row of a dataset and representing it as a unit. Advantages of using units are described in the following list \iacite{Drucker2015}:
\begin{itemize}

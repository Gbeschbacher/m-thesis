...
\begin{table}[!htp]
    ...
    Overview                & ~        & Linear       & Dot                       & Dot              & Dot         &\\[4ex] \hdashline

    Dot Map                 & Linear        & ~       & CB-Linear                       & Color-Linear              & CB-Linear         &\\[4ex] \hdashline

    Proportional Symbol Map & Dot        & CB-Linear       & ~                       & Dot              & Dot         &\\[4ex] \hdashline

    Choropleth Map          & Dot        & Color-Linear       & Dot                       & ~              & Dot         &\\[4ex] \hdashline

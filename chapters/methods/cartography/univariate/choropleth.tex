...
The purpose of choropleth maps also lead to their advantages: it allows to findfindin hot spots and detect relationships between the encoded variable and geographic location.

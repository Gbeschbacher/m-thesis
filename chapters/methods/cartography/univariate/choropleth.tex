...
\item \textbf{Natural breaks classification} follows the idea of minimising the internal variation of the dataset while maximising the variation among the classes. The user needs to choose significant gaps in the dataset, according to the number of desired classes \iacite{McMaster2010}.

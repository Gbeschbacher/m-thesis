...
\begin{figure}[!htb]
\centering
\includegraphics[height=5cm,keepaspectratio]{images/va/marks.png}
\caption[
...
\citeauthor{Munzenr2014} states, that all channels are not equal. She says that using two different visual channels on the same data attributed results in different information after it has passed through the perceptual and cognitive processes of the human visual system. The usage of marks and channels in a design should be guided by the principles of expressiveness and effectiveness \iacite{Munzenr2014}.

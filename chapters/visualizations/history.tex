...
\begin{figure}
    ...
    \subcaptionbox
    [
        Peutinger map, Urldate: 07.2106 \newline \small\texttt{\url{https://web.archive.org/web/20080129123649/http://www.kargi.de/Geschichte/Peutinger/Peutinger.bmp}}
    ]
    {
        Peutinger map\label{fig:peutinger}
    }
	[.4\linewidth]
    {
        \includegraphics[width=0.4\textwidth]{images/history/peutinger.png}
    }
    \qquad
    \subcaptionbox
    [
    ...
    {
        Peutinger map with Rome as central point\label{fig:peutinger-rome}
    }
    [.4\linewidth]
    {
        \includegraphics[width=0.4\textwidth]{images/history/peutinger_rom.jpg}
    }
\caption{Two animals}
\label{animals}
\end{figure}

...
\begin{figure}[!htb]
\centering
\includegraphics[height=5cm,keepaspectratio]{images/history/ortelius.jpeg}
\caption[
...
\begin{quote}
``[\ldots] this appeared to do for graphics what Mendeleev had done for the organisation of the chemical elements, that is, to organise the visual and perceptual elements of graphics according to the features and relations in data \iacite{Friendly.2001}.''
\end{quote}

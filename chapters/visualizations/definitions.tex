In order to fully understand this section, the definition of the term "visualization" needs to be clear (see chapter \ref{s:definition} on page \pageref{s:definition} for more information).
...
A close related, yet distinc field, called \ac{SciVis}, is primarily concerned with the visualization of 3D phenomena, where the emphasis is on realistic renderings of volumes, surfaces, etc. 3D Phenomenas for \ac{SciVis} could be of architectural, meteorological, medical nature and so forth \iacite{Friendly.2001}.

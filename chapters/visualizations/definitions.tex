In order to fully understand this section, the definition of the term "visualisation" needs to be clear (see chapter \ref{s:definition} on page \pageref{s:definition} for more information).
...
\citeauthor{Friendly.2001} refers to \ac{InfoVis} to the broadest term that could be used to group all the developments mentioned in section \ref{s:history}. From a very basic point of view, almost everything, if sufficiently organized, contains information in some kind. Therefore the term can be used for the earliest attempts to scratch information on rocks and to the earliest use of diagrams in history \iacite{Friendly.2001}.
...
The latter definition is closer to the term usage of today. It is generally applied to the visual representation of large-scale collections of non-numerical information. \citeauthor{Shneiderman1996} published the often cited visual information seeking mantra, which is explained in detail in chapter \ref{s:interaction} on page \pageref{s:interaction} \iacite{Shneiderman1996}:
\begin{quote}
"Overview first, zoom and filter, then details on demand."
\end{quote}

\ditem{\acl{SciVis}} \hfill \\
A close related, yet distinct field, called \ac{SciVis}, is primarily concerned with the visualisation of 3D phenomena, where the emphasis is on realistic renderings of volumes, surfaces, etc. 3D Phenomena for \ac{SciVis} could be of architectural, meteorological, medical nature and so forth \iacite{Friendly.2001}.
